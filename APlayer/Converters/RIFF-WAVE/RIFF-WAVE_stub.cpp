/******************************************************************************/
/* RIFF-WAVE Converter Stub Interface.                                        */
/******************************************************************************/
...
void Load(APGlobalData *global, PString fileName)
{
	...
	ext.LoadString(&res, IDS_RIFFWAVE_EXTENSION);
	shortDescr.LoadString(&res, IDS_RIFFWAVE_SHORT_DESCRIPTION);
	longDescr.LoadString(&res, IDS_RIFFWAVE_LONG_DESCRIPTION);

	// Install the mime type + icon
	global->fileTypes->RegisterFileType(&res, IDI_RIFFWAVE_FILEICON, type, ext, longDescr, shortDescr);
	...
	try
	{
		saveSettings->LoadFile("RIFF-WAVE.ini", "Polycode", "APlayer");
	}
...
{
	return (new RIFFWAVEConverter(global, fileName));
}
...
void FixSettings(PResource *res, PSettings *settings)
{
	...
	{
		tempStr.LoadString(res, IDS_RIFFWAVE_FORMAT_PCM);
