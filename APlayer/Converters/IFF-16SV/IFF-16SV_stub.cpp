/******************************************************************************/
/* IFF-16SV Converter Stub Interface.                                         */
/******************************************************************************/
...
void Load(APGlobalData *global, PString fileName)
{
	...
	ext.LoadString(&res, IDS_IFF16SV_EXTENSION);
	shortDescr.LoadString(&res, IDS_IFF16SV_SHORT_DESCRIPTION);
	longDescr.LoadString(&res, IDS_IFF16SV_LONG_DESCRIPTION);

	// Install the mime type + icon
	global->fileTypes->RegisterFileType(&res, IDI_IFF16SV_FILEICON, type, ext, longDescr, shortDescr);
}
...
{
	return (new IFF16SVConverter(global, fileName));
}
