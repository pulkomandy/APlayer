/******************************************************************************/
/* IFF-16SV Converter header file.                                            */
/******************************************************************************/
...
#ifndef __IFF16SVConverter_h
#define __IFF16SVConverter_h
...
/* Sample formats                                                             */
/******************************************************************************/
#define IFF16SV_FORMAT_PCM				0x00	// Plain PCM
...
{
public:
	IFF16SVFormat(PResource *resource);
	virtual ~IFF16SVFormat(void);
	...
	virtual uint32 WriteData(PFile *file, PFile *stereoFile, int16 *buffer, uint32 length, const APConverter_SampleFormat *convInfo);
...
/* IFF16SVPCM class                                                           */
/******************************************************************************/
class IFF16SVPCM : public IFF16SVFormat
{
public:
	IFF16SVPCM(PResource *resource);
	virtual ~IFF16SVPCM(void);
...
/******************************************************************************/
class IFF16SVConverter : public APAddOnConverter
{
public:
	IFF16SVConverter(APGlobalData *global, PString fileName);
	virtual ~IFF16SVConverter(void);
