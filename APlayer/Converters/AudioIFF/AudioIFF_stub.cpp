/******************************************************************************/
/* AudioIFF Converter Stub Interface.                                         */
/******************************************************************************/
...
void Load(APGlobalData *global, PString fileName)
{
	...
	ext.LoadString(&res, IDS_AUDIOIFF_EXTENSION);
	shortDescr.LoadString(&res, IDS_AUDIOIFF_SHORT_DESCRIPTION);
	longDescr.LoadString(&res, IDS_AUDIOIFF_LONG_DESCRIPTION);

	// Install the mime type + icon
	global->fileTypes->RegisterFileType(&res, IDI_AUDIOIFF_FILEICON, type, ext, longDescr, shortDescr);
}
...
{
	return (new AudioIFFConverter(global, fileName));
}
