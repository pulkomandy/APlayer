/******************************************************************************/
/* APDiskButton implementation file.                                          */
/******************************************************************************/
...
/* Constructor                                                                */
/******************************************************************************/
APDiskButton::APDiskButton(PResource *res, int32 normalIconID, int32 pressedIconID, BRect frame, BMessage *message, uint32 resizingMode, uint32 flags) : BPictureButton(frame, NULL, new BPicture(), new BPicture(), message, B_ONE_STATE_BUTTON, resizingMode, flags)
{
	uint8 icon[256];
...
/* Destructor                                                                 */
/******************************************************************************/
APDiskButton::~APDiskButton(void)
{
	delete imagePressed;
	delete imageNormal;
}
...
/******************************************************************************/
void APDiskButton::AttachedToWindow(void)
{
	font_height fh;
...
/******************************************************************************/
void APDiskButton::DrawFrame(float width, float height, bool selected)
{
	// Draw the frame
	if (selected)
	{
