...
class _IMPEXP_APKIT CLVColumnLabelView;
class _IMPEXP_APKIT CLVFillerView;
class _IMPEXP_APKIT CLVContainerView;
...
class _IMPEXP_APKIT ColumnListView : public BListView
{
	public:
