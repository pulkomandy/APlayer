...
//******************************************************************************************************
class _IMPEXP_APKIT ColumnListView;
class _IMPEXP_APKIT CLVColumn;
class _IMPEXP_APKIT CLVListItem;
...
void _IMPEXP_APKIT GetTruncatedString(const char* full_string, char* truncated, float width, int32 truncate_buf_size,
	const BFont* font);
