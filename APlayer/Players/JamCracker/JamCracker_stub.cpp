/******************************************************************************/
/* JamCracker Player Stub Interface.                                          */
/******************************************************************************/
...
void Load(APGlobalData *global, PString fileName)
{
	...
	ext.LoadString(&res, IDS_JAM_EXTENSION);
	shortDescr.LoadString(&res, IDS_JAM_SHORT_DESCRIPTION);
	longDescr.LoadString(&res, IDS_JAM_LONG_DESCRIPTION);

	// Install the mime type + icon
	global->fileTypes->RegisterFileType(&res, IDI_JAM_FILEICON, type, ext, longDescr, shortDescr);
}
...
{
	return (new JamCracker(global, fileName));
}
