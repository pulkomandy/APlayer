/******************************************************************************/
/* Sawteeth Player Stub Interface.                                            */
/******************************************************************************/
...
void Load(APGlobalData *global, PString fileName)
{
	...
	ext.LoadString(&res, IDS_SAW_EXTENSION);
	shortDescr.LoadString(&res, IDS_SAW_SHORT_DESCRIPTION);
	longDescr.LoadString(&res, IDS_SAW_LONG_DESCRIPTION);

	// Install the mime type + icon
	global->fileTypes->RegisterFileType(&res, IDI_SAW_FILEICON, type, ext, longDescr, shortDescr);
}
...
{
	return (new Sawteeth(global, fileName));
}
