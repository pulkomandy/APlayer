/******************************************************************************/
/* SoundMonitor Player Stub Interface.                                        */
/******************************************************************************/
...
void Load(APGlobalData *global, PString fileName)
{
	...
	ext.LoadString(&res, IDS_BP_EXTENSION);
	shortDescr.LoadString(&res, IDS_BP_SHORT_DESCRIPTION);
	longDescr.LoadString(&res, IDS_BP_LONG_DESCRIPTION);

	// Install the mime type + icon
	global->fileTypes->RegisterFileType(&res, IDI_BP_FILEICON, type, ext, longDescr, shortDescr);
}
...
{
	return (new SoundMonitor(global, fileName));
}
