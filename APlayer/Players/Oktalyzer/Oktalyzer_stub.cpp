/******************************************************************************/
/* Oktalyzer Player Stub Interface.                                           */
/******************************************************************************/
...
void Load(APGlobalData *global, PString fileName)
{
	...
	ext.LoadString(&res, IDS_OKT_EXTENSION);
	shortDescr.LoadString(&res, IDS_OKT_SHORT_DESCRIPTION);
	longDescr.LoadString(&res, IDS_OKT_LONG_DESCRIPTION);

	// Install the mime type + icon
	global->fileTypes->RegisterFileType(&res, IDI_OKT_FILEICON, type, ext, longDescr, shortDescr);
}
...
{
	return (new Oktalyzer(global, fileName));
}
