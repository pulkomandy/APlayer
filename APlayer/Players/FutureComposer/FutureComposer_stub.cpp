/******************************************************************************/
/* FutureComposer Player Stub Interface.                                      */
/******************************************************************************/
...
void Load(APGlobalData *global, PString fileName)
{
	...
	ext.LoadString(&res, IDS_FC_EXTENSION);
	shortDescr.LoadString(&res, IDS_FC_SHORT_DESCRIPTION);
	longDescr.LoadString(&res, IDS_FC_LONG_DESCRIPTION);

	// Install the mime type + icon
	global->fileTypes->RegisterFileType(&res, IDI_FC_FILEICON, type, ext, longDescr, shortDescr);
}
...
{
	return (new FutureComposer(global, fileName));
}
