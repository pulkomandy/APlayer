...
#ifndef __ProWizardAgent_h
#define __ProWizardAgent_h
...
/******************************************************************************/
/* ProWizardAgent class                                                       */
/******************************************************************************/
class ProWizardAgent : public APAddOnAgent
{
public:
	ProWizardAgent(APGlobalData *global, PString fileName);
	virtual ~ProWizardAgent(void);
...
protected:
	...
	ap_result CheckModule(const PBinary &module, APAgent_ConvertModule *convInfo);

	PResource *res;

	PList<ProWizard *> converters;
};
